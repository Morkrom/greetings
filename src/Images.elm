...
phone = svg
    ...
    [ rect [ x "15"
     ...
     |> Debug.log ("appies" ++ Debug.toString (phoneApps 25.0))
     |> Debug.log ("Log phone apps elements:" ++ Debug.toString (phoneAppsElements phoneAppSize)) 
     |> Debug.log (Debug.toString (phoneAppsRow  25.0 1))
     |> Debug.log (Debug.toString phoneColumns)
