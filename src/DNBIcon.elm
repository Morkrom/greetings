...
brainSvgBigZoomie : Svg.Svg msg
brainSvgBigZoomie =
    Svg.svg
        [ attribute "x" "0px"
        , attribute "y" "0px"
        , attribute "viewBox" "0 0 463 463"
        , width "100%"
        , height "100%"
        ...
        , Svg.rect
            [ attribute "x" "0px"
            , attribute "y" "0px"
            , attribute "width" "463px"
            , attribute "height" "463px"
            , attribute "fill" "url('#grad')"
            , rx "20"
            , ry "20"
            ]
            []
        , Svg.svg
            [ attribute "x" "0px"
            , attribute "y" "0px"
            , attribute "viewBox" "10 100 200 200"
            ]
            [ Svg.node "g"
                [ attribute "fill" "url('#grad1')", attribute "x" "0px", attribute "y" "0px", attribute "width" "463px", attribute "height" "463px" ]
                [ Svg.node "path" [ attribute "d" """M151.245,222.446C148.054,237.039,135.036,248,119.5,248c-4.142,0-7.5,3.357-7.5,7.5s3.358,7.5,7.5,7.5
...
\t\t\t\tc0-4.143-3.358-7.5-7.5-7.5s-7.5,3.357-7.5,7.5C96,191.715,120.119,218.384,151.245,222.446z""" ] []
                , Svg.node "path" [ attribute "d" """M183,287.5c0-4.143-3.358-7.5-7.5-7.5c-35.014,0-63.5,28.486-63.5,63.5c0,0.362,0.013,0.725,0.019,1.088
...
\t\t\t\tc0-26.743,21.757-48.5,48.5-48.5C179.642,295,183,291.643,183,287.5z""" ] []
                , Svg.node "path" [ attribute "d" """M439,223.5c0-17.075-6.82-33.256-18.875-45.156c1.909-6.108,2.875-12.426,2.875-18.844
...
\t\t\t\tc16.064,0,30.743-6.008,41.939-15.879c4.306,7.365,6.561,15.68,6.561,24.379C424,314.626,412.68,332.018,395.161,339.807z""" ] []
                , Svg.node "path" [ attribute "d" """M359.5,240c-15.536,0-28.554-10.961-31.745-25.554C358.881,210.384,383,183.715,383,151.5c0-4.143-3.358-7.5-7.5-7.5
...
\t\t\t\tc4.142,0,7.5-3.357,7.5-7.5S363.642,240,359.5,240z""" ] []
                , Svg.node "path" [ attribute "d" """M335.5,328c-2.89,0-5.73,0.212-8.519,0.588c0.006-0.363,0.019-0.726,0.019-1.088c0-35.014-28.486-63.5-63.5-63.5
   ...
   brainSvgBigZoomie =
       svg
           ...
           , Svg.rect
               ...
               [ Svg.node "g"
                   [ attribute "fill" "url('#gradin')", attribute "filter" "url(#invert)", attribute "x" "0px", attribute "y" "0px", attribute "width" "463px", attribute "height" "463px" ]
                   [ Svg.node "path" [ attribute "d" """M151.245,222.446C148.054,237.039,135.036,248,119.5,248c-4.142,0-7.5,3.357-7.5,7.5s3.358,7.5,7.5,7.5
   \t\t\t\tc23.774,0,43.522-17.557,46.966-40.386c14.556-1.574,27.993-8.06,38.395-18.677c2.899-2.959,2.85-7.708-0.109-10.606
   \t\t\t\tc-2.958-2.897-7.707-2.851-10.606,0.108C184.947,202.829,172.643,208,159.5,208c-26.743,0-48.5-21.757-48.5-48.5
   \t\t\t\tc0-4.143-3.358-7.5-7.5-7.5s-7.5,3.357-7.5,7.5C96,191.715,120.119,218.384,151.245,222.446z""" ] []
