...
var $author$project$DNBIcon$brainSvgBigZoomie = A2(
	...
	_List_fromArray(
		[
			...
			A2($elm$virtual_dom$VirtualDom$attribute, 'viewBox', '0 0 463 463'),
			$elm$svg$Svg$Attributes$width('100%'),
			$elm$svg$Svg$Attributes$height('100%'),
			$elm$svg$Svg$Attributes$preserveAspectRatio('none'),
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A2($elm$virtual_dom$VirtualDom$attribute, 'id', 'grad'),
							A2($elm$virtual_dom$VirtualDom$attribute, 'x1', '0'),
							A2($elm$virtual_dom$VirtualDom$attribute, 'x2', '1'),
							A2($elm$virtual_dom$VirtualDom$attribute, 'y1', '1'),
							A2($elm$virtual_dom$VirtualDom$attribute, 'y2', '0')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									A2($elm$virtual_dom$VirtualDom$attribute, 'offset', '25%'),
									A2($elm$virtual_dom$VirtualDom$attribute, 'stop-color', '#40e8cc')
								]),
							_List_fromArray(
								[
									A2(
									...
									_List_fromArray(
										[
											$elm$svg$Svg$Attributes$attributeName('stop-color'),
											$elm$svg$Svg$Attributes$values('#40e8cc;#e61e45;#40e8cc'),
											$elm$svg$Svg$Attributes$dur('1.8s'),
											$elm$svg$Svg$Attributes$repeatCount('0'),
											$elm$svg$Svg$Attributes$begin('indefinite'),
											$elm$svg$Svg$Attributes$restart('whenNotActive')
										]),
									_List_Nil)
								])),
							A2(
							...
							_List_fromArray(
								[
									A2($elm$virtual_dom$VirtualDom$attribute, 'offset', '75%'),
									A2($elm$virtual_dom$VirtualDom$attribute, 'stop-color', '#e61e45')
								]),
							_List_fromArray(
								[
									A2(
									...
									_List_fromArray(
										[
											$elm$svg$Svg$Attributes$attributeName('stop-color'),
											$elm$svg$Svg$Attributes$values('#e61e45;#40e8cc;#e61e45;'),
											$elm$svg$Svg$Attributes$dur('1.8s'),
											$elm$svg$Svg$Attributes$repeatCount('0'),
											$elm$svg$Svg$Attributes$begin('indefinite')
										]),
					...
					_List_fromArray(
						[
							A2($elm$virtual_dom$VirtualDom$attribute, 'id', 'grad1'),
							A2($elm$virtual_dom$VirtualDom$attribute, 'x1', '0'),
							A2($elm$virtual_dom$VirtualDom$attribute, 'x2', '1'),
							A2($elm$virtual_dom$VirtualDom$attribute, 'y1', '1'),
							A2($elm$virtual_dom$VirtualDom$attribute, 'y2', '0')
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($elm$virtual_dom$VirtualDom$attribute, 'offset', '30%'),
									A2($elm$virtual_dom$VirtualDom$attribute, 'stop-color', '#e61e45')
								]),
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$svg$Svg$Attributes$attributeName('stop-color'),
											$elm$svg$Svg$Attributes$values('#e61e45;#40e8cc;#e61e45'),
											$elm$svg$Svg$Attributes$dur('1.7s'),
											$elm$svg$Svg$Attributes$repeatCount('0'),
											$elm$svg$Svg$Attributes$begin('indefinite')
										]),
									_List_Nil)
							...
							_List_fromArray(
								[
									A2($elm$virtual_dom$VirtualDom$attribute, 'offset', '60%'),
									A2($elm$virtual_dom$VirtualDom$attribute, 'stop-color', '#40e8cc')
								]),
							_List_fromArray(
								[
			...
			_List_fromArray(
				[
					A2($elm$virtual_dom$VirtualDom$attribute, 'x', '0px'),
					A2($elm$virtual_dom$VirtualDom$attribute, 'y', '0px'),
					A2($elm$virtual_dom$VirtualDom$attribute, 'width', '463px'),
					A2($elm$virtual_dom$VirtualDom$attribute, 'height', '463px'),
					A2($elm$virtual_dom$VirtualDom$attribute, 'fill', 'url(\'#grad\')'),
					$elm$svg$Svg$Attributes$rx('20'),
					$elm$svg$Svg$Attributes$ry('20')
				]),
			_List_Nil),
			...
			_List_fromArray(
				[
					A2($elm$virtual_dom$VirtualDom$attribute, 'x', '0px'),
					A2($elm$virtual_dom$VirtualDom$attribute, 'y', '0px'),
					A2($elm$virtual_dom$VirtualDom$attribute, 'viewBox', '10 100 200 200')
				]),
			_List_fromArray(
				[
					A3(
					...
					_List_fromArray(
						[
							A2($elm$virtual_dom$VirtualDom$attribute, 'fill', 'url(\'#grad1\')'),
							A2($elm$virtual_dom$VirtualDom$attribute, 'x', '0px'),
							A2($elm$virtual_dom$VirtualDom$attribute, 'y', '0px'),
							A2($elm$virtual_dom$VirtualDom$attribute, 'width', '463px'),
							A2($elm$virtual_dom$VirtualDom$attribute, 'height', '463px')
...
var $author$project$AppleseGallerySlide$slideLogo = function (data) {
	switch (data.$) {
		case 'Dnb':
			return $author$project$DNBIcon$brainSvgBigZoomie;
		case 'IzOn':
						...
						[
							...
							_List_fromArray(
								[
									...
									A2($elm$html$Html$Attributes$style, 'min-width', componentData.svgSize.w),
									A2($elm$html$Html$Attributes$style, 'min-height', componentData.svgSize.h)
								]),
							_List_fromArray(
								[
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$svg$Svg$Attributes$rx('3px'),
						$elm$svg$Svg$Attributes$ry('3px')
					]),
				_List_Nil),
				A2(
				$elm$svg$Svg$animate,
